...
-- Clipboard
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd("cliphist wipe && notify-send 'Presse papier' 'Le presse papier à bien était vidé' || notify-send '⚠️ Erreur ⚠️' 'Impossible de vider le presse paper'"))
